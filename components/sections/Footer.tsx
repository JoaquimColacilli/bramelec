  ...
  return (
    <footer className="relative bg-[#A60C38] text-white" ref={ref}>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 group">
                ...
                <span className="group-hover:text-white/80 transition-colors duration-300">+54 11 1234-5678</span>
              </div>
              <div className="flex items-center space-x-3 group">
                <Mail className="h-5 w-5 text-white group-hover:scale-110 transition-transform duration-300" />
                <span className="group-hover:text-white/80 transition-colors duration-300">contacto@bramelec.com</span>
              </div>
              <div className="flex items-center space-x-3 group">
                <MapPin className="h-5 w-5 text-white group-hover:scale-110 transition-transform duration-300" />
                <span className="group-hover:text-white/80 transition-colors duration-300">Buenos Aires, Argentina</span>
              </div>
            </div>
          </motion.div>
        ...
        >
          <p>&copy; {new Date().getFullYear()} BRAMELEC. Todos los derechos reservados.</p>
        </motion.div>
      </div>
    </footer>
  );
